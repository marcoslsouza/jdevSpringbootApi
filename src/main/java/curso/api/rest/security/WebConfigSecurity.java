...
public class WebConfigSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Filtra requisicoes de login para autenticacao (Falta implementar as classes)
		
		// Filtra demais requisicoes para verificar a presenca do TOKEN JWT no HEADER HTTP (Falta implementar as classes)
	}
